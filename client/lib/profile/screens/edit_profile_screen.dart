...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  _setInitialDateValue() async {
    CommonResponse<UserDetailResponse> snapshot = await ProfileService.getUserDetail(context);
    ...
    if (formattedDate == "1/1/1") {
      ...
      DateTime dateTime = DateTime.fromMillisecondsSinceEpoch(epochTimeInSeconds * 1000, isUtc: true);
                                  ...
                                  data: Theme.of(context).copyWith(
                                    ...
                                    textButtonTheme: TextButtonThemeData(
                                      style: TextButton.styleFrom(
                                        foregroundColor: const Color(0xFFFF5C96),
                                      ),
                                    ),
  ...
  void _updateProfile() async {
    if (_editFormKey.currentState!.validate()) {
      ...
      CommonResponse response = await ProfileService.updateUserDetail(context, body);
